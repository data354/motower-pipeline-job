...
def extract_fa():
    data = extract(host= PG_HOST, database= PG_DB, user= PG_USER, password= PG_PASSWORD , table=None, date=None , request="select * from faitalarme where date between '2023-01-01' and '2023-03-27' order by date;")
    client = Minio(
        MINIO_ENDPOINT,
