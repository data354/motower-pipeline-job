...
def gen_oneforall(**kwargs):
    ...
    if not data.empty:
        ...
        data_faits = data[["mois","code_oci","ca_voix","ca_data","parc_global","parc_data","parc_2g","parc_3g", "parc_4g","parc_5g","autre_parc","o_m",
                    "energie","infra","maintenance_passive_preventive","garde_de_securite","discount","volume_discount","tva","opex_itn","trafic_data_v2_2g",
                    "trafic_data_v2_3g","trafic_data_v2_4g","trafic_voix_v2_2g","trafic_voix_v2_3g","trafic_voix_v2_4g","cellules_v2_2g","cellules_congestionne_v2_2g",
                    "cellules_v2_3g","cellules_congestionne_v2_3g","cellules_v2_4g","cellules_congestionne_v2_4g","ca_total","cellules_congestionnees_total_v2",
                    "cellules_total_v2","taux_congestion_2g_v2","taux_congestion_3g_v2", "taux_congestion_4g_v2","taux_congestion_total_v2","arpu","interco","impot",
                    "frais_dist","opex","autre_opex","ebitda","marge_ca","days","segment","previous_segment", "evolution_segment"]]

        data_dim = data[["mois","days","code_oci","site","autre_code","longitude","latitude","type_du_site","statut","localisation","commune",
                    "departement","region","partenaires","proprietaire","gestionnaire","type_geolocalite","projet","clutter","position_site",                  
                    "pareto","recommandation_v2","segmentation_rentabilite_v2","rentable","niveau_rentabilite"]]
        data_faits["avg_2g_cssr_cs"]=0
        data_faits["avg_3g_cssr_cs"]=0
