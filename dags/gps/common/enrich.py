...
from gps.common.rwminio import  get_latest_file, read_file, save_minio
import logging
...
def oneforall(client, endpoint:str, accesskey:str, secretkey:str,  date: str, start_date):
    ...
    logging.info("final columns to rename")
    renamed_columns = {
    'mois_x':'mois',
    'code oci':'code_oci', 'site':'site', 'autre code':'autre_code',    'longitude':'longitude',    'latitude':'latitude',    'partenaires':'partenaires',    'proprietaire':'proprietaire',    
    'type du site':'type_du_site',     'statut':'statut',    'localisation':'localisation',     'commune':'commune',     'departement':'departement',     'region':'region',    'gestionnaire':'gestionnaire',    
    'type geolocalite':'type_geolocalite',    'projet':'projet',     'clutter':'clutter',     'position site':'position_site',     'ca_voix':'ca_voix',     'ca_data':'ca_data',     'ca_total':'ca_total',    'parc':'parc_global',     'parc_data':'parc_data',    
    "parc_2g":"parc_2g",    "parc_3g":"parc_3g",     "parc_4g":"parc_4g",     "parc_5g":"parc_5g",     "parc_other":"autre_parc",    'o&m_x':'o_m',     'energy_x':'energie',     'infra_x':'infra',    
    'maintenance passive preventive_x':'maintenance_passive_preventive',    'gardes de securite_x':'garde_de_securite',     'discount_x':'discount',     'volume discount_x' :'volume_discount',    'tva : 18%':'tva',    
    "month_total":"opex_itn","trafic_data_go_2G":"trafic_data_v2_2g", "trafic_data_go_3G":"trafic_data_v2_3g",     "trafic_data_go_4G":"trafic_data_v2_4g",     "trafic_voix_erl_2G":"trafic_voix_v2_2g",     
    "trafic_voix_erl_3G":"trafic_voix_v2_3g",    "trafic_voix_erl_4G":"trafic_voix_v2_4g", "nbre_cellule_2G":"cellules_v2_2g",    "nbre_cellule_congestionne_2G":"cellules_congestionne_v2_2g",    "nbre_cellule_3G":"cellules_v2_3g",    
    "nbre_cellule_congestionne_3G":"cellules_congestionne_v2_3g",    "nbre_cellule_4G":"cellules_v2_4g", "nbre_cellule_congestionne_4G":"cellules_congestionne_v2_4g" }
    #print(df_final.columns)
    #print(df_final.shape)
    df_final.rename(columns =renamed_columns, inplace=True)
    ...
    # enrich
    #save_minio(client=client, bucket=CONFIG["final_bucket"], date=date, data=df_final, folder="test/df_final")
    ...
    print(oneforall.columns)
    #save_minio(client=client, bucket=CONFIG["final_bucket"], date=date, data=oneforall, folder="test")
